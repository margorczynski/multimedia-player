...
public class AaaLeftMenuPanel_v2 extends JPanel 
{
	public AaaLeftMenuPanel_v2()
	{
		super();
		initComponents();
	...
	public void initComponents()
	{
		...
		this.add(tabbedPane);
		this.setPreferredSize(new Dimension(LEFT_MENU_PANEL_WIDTH, AaaMainWindow.WINDOW_HEIGHT));
