...
public class AaaMainWindow extends JFrame 
{

	
	public AaaMainWindow()
	{
	...
	public void initComponents()
	{
		...
		// Lewy  panel z menu
		leftMenuPanel = new AaaLeftMenuPanel_v2();
		...
		rightPlayerPanel = new AaaPlayerPanel();
	...
	AaaPlayerPanel rightPlayerPanel;
	AaaLeftMenuPanel_v2 leftMenuPanel;
	JMenuBar menuBar ;
	JToolBar toolBar;
